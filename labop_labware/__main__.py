...
"""Console script for labop_labware."""
...
from .labop_labware_impl import HelloWorld
...
def main():
    ...
    print("Replace this message by putting your code into labop_labware.__main__")
