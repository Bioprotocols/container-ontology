...
class InlineResponse200(ModelNormal):
    ...
    attribute_map = {
        'id': '@id',  # noqa: E501
        'has_instance': 'hasInstance',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, has_instance, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            value (str): The query string, translated to functional syntax. Not present if ID is sufficient.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, has_instance, *args, **kwargs):  # noqa: E501
        """InlineResponse200 - a model defined in OpenAPI
